...
function serializeCandidate(
  ...
  return {
    ...
    scores: {
      ...
      priceAction: latestPriceCheck ? candidate.priceActionScore : null,
      volume: latestPriceCheck ? candidate.volumeScore : null,
      risk: latestPriceCheck ? candidate.riskScore : null,
      total: candidate.totalScore,
    },
    evaluated: latestPriceCheck !== null,
