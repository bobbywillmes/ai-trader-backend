...
function Attention({ dataAvailable, accountBlocked, risk }: { dataAvailable: boolean; accountBlocked: boolean; risk?: EntryReadiness }) {
  const issues = [
