  ...
  return (
    <Card withBorder radius="md" p="lg" h="100%">
      <Stack gap="md" h="100%">
        ...
        {data.length === 0 ? <EmptyState>No catalyst events were received in the last 24 hours.</EmptyState> : <ScrollArea type="auto" mah={900} offsetScrollbars style={{ flex: 1, minHeight: 0 }}>{data.map((event) => (
