...
vi.mock("./hooks", () => ({
  ...
  useAttentionDetail: () => ({ data: mocks.detail, isLoading: false, isError: Boolean(mocks.detailError), error: mocks.detailError }),
...
beforeEach(() => { mocks.searches.length = 0; mocks.detail = undefined; mocks.detailError = null; }); afterEach(cleanup);
