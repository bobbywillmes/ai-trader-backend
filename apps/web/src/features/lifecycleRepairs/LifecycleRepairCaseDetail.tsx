import { Accordion, Alert, Badge, Button, Card, Group, SimpleGrid, Stack, Table, Text, Title } from "@mantine/core";
...
export function LifecycleRepairCaseDetail({ item, onApply, onDiagnoseAgain }: { item: LifecycleRepairCase; onApply: () => void; onDiagnoseAgain: () => void }) {
