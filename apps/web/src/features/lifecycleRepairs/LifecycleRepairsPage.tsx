...
import { useApplyLifecycleRepair, useApplyLifecycleRepairAction, useDecideLifecycleRepairAction, useDiagnoseLifecycleRepair, useLifecycleRepairs, usePreviewHistoricalEntryLifecycle, useReconsiderLifecycleRepairAction } from "./hooks";
...
export function LifecycleRepairsPage() {
  ...
  const reconsiderAction = useReconsiderLifecycleRepairAction(token);
