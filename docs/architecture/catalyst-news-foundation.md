...
Phase 2 adds an optional backend worker for polling Massive reference news for
watched stock symbols. It does not add n8n triggers, admin UI pages, candidate
generation, final scoring, broker behavior, or trading behavior.
...
The following remain intentionally out of scope after Phase 2:
