...
| `volatility_assessment_publication` | Daily Volatility assessment | startup + 15m | informational | Account-independent VOLATILITY_V1 publication; separate transaction advisory lock, chronological catch-up, persisted recovery confirmation. Requires calendar bootstrap; no trading consumer. |
